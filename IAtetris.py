...
def main(win):
    ...
    global kdiu
    pecestotals = 0
    comparar=0 #quines peces agafara- 0:aleatories 1:guardar les peces que surtin 2:jugar amb les peces guardades
    IA=1 #desideix el tipus de jugavilitat: si IA=1 juga la inteligencia artificial, si no pot jugar el jugador
    if comparar==1:
                      ...
                      if tipus ==0:
                          if forats[i] != -1:
                              if forats[i] < miju:
                                  ...
                                  miforax = forax[i]
                                  millori = i
                              elif forats[i] == miju:#si els forats son iguals mirar quina de les dos altures esta mes aprop del terra
                                  if rows[i] > mijulin:
                                      mijulin = rows[i]
                                      mijualt = altura[i]
                                      mijudis = disfo[i]
                                      mijudith = dith[i]
                                      miforax = forax[i]#crec que no cal pero passo de borrar
                                      millori = i
                                  elif rows[i] == mijulin:
                                      if altura[i] > mijualt:
                                          mijualt = altura[i]
                                          ...
                                          miforax = forax[i]
                                          millori = i
                                      elif altura[i] == mijualt: #que es millor, la altura o les linies?
                                          if disfo[i]< mijudis:
                                              mijudis = disfo[i]
                                              mijudith = dith[i]
                                              miforax = forax[i]
                                              millori = i
                                          elif disfo[i] == mijudis:
                                              if dith[i] > mijudith:
                                                  mijudith = dith[i]
                                                  miforax = forax[i]
                                                  millori = i
                                              elif dith[i] == mijudith:
                                                  if forax[i] < miforax:
                                                      miforax = forax[i]
                                                      millori = i
                                              """if forax[i] < miforax:
                          ...
                          if forats[i] != -1:
                              ...
                              forats[i]=forats[i]-altura[i] #mitjana ponderada entre altura i forats
                              if forats[i] < miju:
                                  miju = forats[i]
                                  mijualt = altura[i]
                                  mijulin = rows[i]
